...
const cocktailData = [
    ...
    },
    {
        ...
        comment3: '언뜻 강할 수 있는 소금, 라임, 데킬라의 맛들을 코인트루가 부드럽게 감아 내 준다.',
        bmtiComment1: 'T',
        bmtiComment2: '마가리타',
        bmtiComment3: '이야기',
    ...
    },
    {
        ...
        comment2: '강렬한 색과 이름과는 달리 도수가 낮고, 건강한 재료 덕에 외국에서는 해장술로도 불린답니다!',
        comment3: '달콤하면서도 쌉쌀한 맛과 향긋함이 느껴지는 복잡하면서도 중독적인 맛이 매력적!',
        bmtiComment1: 'F',
        bmtiComment2: '블러디메리',
        bmtiComment3: '유래',
    ...
    },
    {
        ...
        comment3: '도수가 낮고 알코올의 씁쓸한 맛이 없어 쭉쭉 마시다보면 어느새 비틀거리는 나를 볼수도..?!',
        bmtiComment1: '달달한 S',
        bmtiComment2: '프렌치키스',
        bmtiComment3: '영화',
        bmtiImg: '../img/bmtiImg/프렌치키스.png',
        bmtiComment4: '세미나 차 파리에 가자는 찰리의 제의를 거절하고 집에 홀로 남은 케이트',
    ...
    },
    {
        ...
        comment2: '거친 이름과는 다르게 커피, 초콜릿, 오렌지 리큐르만을 사용하여 아주 달고 부드러운 맛을 느낄 수 있습니다!',
        comment3: '도수가 높은 럼을 얇게 표면에 얹어서 불을 붙이면 이것이야 말로 화룡점정!',
        bmtiComment1: '강렬한 D',
        bmtiComment2: 'B-52',
